...
import com.lipop.micro.house.biz.interceptor.UserContext;
import com.lipop.micro.house.biz.service.*;
...
import com.lipop.micro.house.common.result.ResultMsg;
...
public class HouseController {
	...
	public String houseList(Integer pageSize, Integer pageNum, HouseVo query, ModelMap modelMap){
	  PageData<HouseVo> ps =  houseService.queryHouse(query, PageParams.build(pageSize, pageNum));
	  List<HouseVo> hotHouses =  recommendService.getHotHouse(Constants.RECOM_SIZE);
	...
	public String doAdd(HouseVo house){
		...
		house.setState(Constants.HOUSE_STATE_UP);
	...
	public String houseDetail(Long id,ModelMap modelMap){
	    ...
	    List<HouseVo> rcHouses =  recommendService.getHotHouse(Constants.RECOM_SIZE);
	...
	public String houseMsg(HouseMsgVo userMsg){
	...
	public String bookmarked(HouseVo house,Integer pageNum,Integer pageSize,ModelMap modelMap){
		User user = UserContext.getUser();
