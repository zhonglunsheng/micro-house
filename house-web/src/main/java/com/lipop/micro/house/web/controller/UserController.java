...
import com.lipop.micro.house.biz.service.AgencyService;
import com.lipop.micro.house.biz.service.UserService;
...
public class UserController {
  ...
  public String accountsRegister(UserVo account, ModelMap modelMap) {
  ...
  public String profile(HttpServletRequest req, User updateUser, ModelMap model) {
    ...
    req.getSession(true).setAttribute(Constants.USER_ATTRIBUTE, users.get(0));
  ...
  public String resetSubmit(HttpServletRequest req,User user){
    ...
    req.getSession(true).setAttribute(Constants.USER_ATTRIBUTE, updatedUser);
